...
export const API_CONFIG = {
  ...
  BASE_URL: IS_DEV ? 'http://127.0.0.1:8080/api' : 'https://api.farmsense.kr/api',
  // RAG 서버 (질의응답)
  RAG_URL: IS_DEV ? 'http://127.0.0.1:8080/api' : 'https://api.farmsense.kr/api',
  // 병해 진단 서버 (이미지 분석)
  DIAGNOSIS_URL: IS_DEV ? 'http://127.0.0.1:8080/api' : 'https://api.farmsense.kr/api',
  TIMEOUT: 30000,
  ENDPOINTS: {
    DIAGNOSIS: {
...
export const PLAN_CONFIG = {
  ...
  YEARLY_PRICE: 100000,    // 년 100,000원
  TRIAL_MONTHS: 2,
};
